                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>I completed my undergraduate studies for my Bachelor of Science in computer science with a minor in management and began my graduate studies at the University of Minnesota, Twin Cities to obtain my Master of Science in computer science. Planning to pursue research in software engineering.</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>Undergraduate teaching assistant for the course: CSCI3081W - Program Design and Development under Dr. Mattia Fazzini. I collaborated with teaching staff to administer coursework, evaluate submissions, and analyze class performance in a remote learning environment due to COVID-19.</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>Appointed Event Chairman of the University of Minnesota's chapter of WECharity. My role was to organize charity events to raise money for specific causes. Our highlight for this year was raising over $2000 for folks in Yemen who were severely affected by the COVID-19 pandemic.</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>Joined as a programming mentor for a nonprofit organization which aims to support and increase the number of women in computer science by equipping young women with the necessary computing skills to pursue 21st century opportunities. </p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>At RSM, I was a technology consultant intern on the application development team. Here, I consulted with clients on the design and optimization of controls, solutions, and products utilizing extensive knowledge of information systems. I was introduced to creating solutions for clients rather than for internal use. My first project was developing a ticketing management system using .NET Core full-stack web application framework. Then, I implemented a user interface with Vue.js for the first ever ERP-based Blockchain traceability solution.</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>Joined my school's app dev club and I collaborated with developers and researchers to develop an application that assesses students’ competencies to identify particular social and behavioral needs and provides guidance to teachers on how to support their students using Android Studio and Java.</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>Joined an organzation where we mentored youth to code, build a website, create an app or game, and explore technology in an informal, creative, and social environment in a free, volunteer-led, community-based programming club.</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>During most of my undergraduate career, I was a technology help specialist at my school's IT department. For the first two years, I provided technical support for the entire University Community via phone, chat, SMS, email, face-to-­face, and using remote tools. Additionally, I oversaw local and remote computer lab facilities including customer support, security, and hardware/software troubleshooting. In 2019, I was promoted to Desktop Support Specialist where I provided specialized computer and device support in tech support zones. In 2020, I helped facilitate the transition for the entire University staff and faculty to work remotely during the COVID-19 pandemic.</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p style={{color: "#999999"}}>In 2017, I began my undergraduate studies to pursue my Bachelor of Science in computer science at the University of Minnesota, Twin Cities. </p>
                      </div>
                    </div>
                  </article>
